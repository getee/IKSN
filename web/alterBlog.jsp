...
<div class="container-fluid">
    ...
    <div>
        <form id="form" action="/blog/updateBlog/${scanblog.bid}" method="post">
            <input type="hidden" name="uid" value="${sessionScope.loginresult.uid}"/>
            <input type="hidden" name="isdraft" value="${scanblog.userToBlog.isdraft}" id="panduan">
            <div class="input-group input-group-lg" style="width: 1024px;height:15px; margin: auto;">
                <input type="text" class="form-control" id="biaoti"name="title" value="${scanblog.title}" >
            </div>
            <div style="width:1024px;height:430px;margin:auto;margin-top: 10px;">
                <textarea id="editor" type="text/plain" name="content">${requestScope.scanblog.content}</textarea>
            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row" style="padding: 20px">
                                ...
                                <div class="col-md-7">
                                    <div id="InputsWrapper">
                                        <div>
                                            <input type="text" name="btag" id="field_1" value="${scanblog.blogTag.btag}"/>
                            ...
                            <div class="row" style="padding: 40px;">
                                <div class="txt-box" >
                                    ...
                                    <c:if test="${scanblog.userToBlog.blogtype==2}">
                                    <script>
                                    ...
                                    <span class="required">*</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <c:forEach var="n" begin="1" end="${scanblog.classify}">
                                    <script>
                                        $(document).ready(function() {
                                            $("#Type2").val("${scanblog.classify}")
                                        })
                                    </script>
                                        </c:forEach>
                                ...
                                <br>
                                <!---->
                                <label class="control-label">是否设为私密</label>
                                <input type="checkbox" value="0" name="ispublic" id="simi" onclick="this.value=(this.value==0)?1:0">
                                <c:if test="${scanblog.userToBlog.ispublic==1}">
                                    <script>
                                        $(document).ready(function() {
                                            $("#simi").prop("checked",true);
                                        })
                                    </script>
                                </c:if>
                            </div>
